...
const GiftCouponCard = () => {
	...
	return (
		...
		>
            ...
            p-2.5 text-sm text-white placeholder-gray-400 focus:border-blue-600 
            focus:ring-blue-600'
				...
				<motion.button
					type='button'
					className='flex w-full items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-400'
